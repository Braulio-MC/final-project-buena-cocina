...
import com.bmc.buenacocina.ui.viewmodel.StoreReviewViewModel
...
fun StoreReviewScreen(
    ...
    viewModel: StoreReviewViewModel = hiltViewModel(
        creationCallback = { factory: StoreReviewViewModel.StoreReviewViewModelFactory ->
            ...
            when (reviews.loadState.refresh) {
                ...
                is LoadState.NotLoading -> {
                    if (reviews.itemCount == 0) {
                        StoreReviewEmpty(paddingValues)
                    } else {
                        LazyColumn(
                            modifier = Modifier
                                .padding(10.dp)
